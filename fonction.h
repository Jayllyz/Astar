...
// static inline est utile pour optimisé des fonctions très courtes !
// (on avait des soucis sans ca)
...
// DEBUT linked_list
typedef struct linked_node_t { // Structure pour naviguer dans la
                               // liste
